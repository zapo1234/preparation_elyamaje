...
$(".validate_order").on("click", function () {
    ...
    $.ajax({
        ...
        if (JSON.parse(data).success) {
            // Tooltip details
            $(".details_information")
                .text(`Les détails de la commande sont affichés, 
            ...
            var order_shipping_method = order[0].shipping_method
            ...
            $(".detail_shipping_billing").append(`
                <div class="to_hide detail_shipping_billing_div">
                    <div class="d-flex w-100 justify-content-around mb-3">
                        ...
                        ${
                            order_shipping_method.includes("chrono")
                                ? '<div class="shipping_chrono_logo"></div>'
                                : '<span style="width: fit-content" class="badge bg-primary shipping_method">' +
                                      order[0].shipping_method_detail &&
                                  order[0].shipping_method_detail != null
                                ? order[0].shipping_method_detail
                                : "" + "</span>"
                        }
                            <span class="badge bg-dark distributor">${
                                is_distributor ? "Distributrice" : ""
                            }</span>
                        </div>
                        ...
                        <div class="d-flex w-100 justify-content-center">
                            <span style="width: fit-content" class="badge status_order bg-default bg-light-${
                                order[0]["status"]
                            }">${JSON.parse(data).status}</span>
                        </div>
                        ...
                        ${
                            !transfers
                                ...
                                <div class="d-flex flex-column justify-content-between billing_block align-items-center">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <span class="customer_name">${
                                            ...
                                            " " +
                                            order[0].billing_customer_first_name
                                        }</span>
                                        <span class="customer_email">${
                                            order[0].billing_customer_email
                                        }</span>
                                        <span class="customer_billing_adresss1">${
                                            order[0]
                                                .billing_customer_address_1 ??
                                            ""
                                        }</span>
                                        <span class="customer_billing_adresss2">${
                                            order[0]
                                                .billing_customer_address_2 ??
                                            ""
                                        }</span>
                                    </div>
                                </div>
                                <div class="d-flex flex-column justify-content-between shipping_block align-items-center">
                                    ...
                                    <div class="d-flex flex-column align-items-center">
                                        <span class="customer_shipping_name">${
                                            order[0]
                                        ...
                                        <span class="customer_shipping_company">${
                                            order[0]
                                                .shipping_customer_company ?? ``
                                        }</span>
                                        <span class="customer_shipping_adresss1">${
                                            order[0].shipping_customer_address_1
                                        }</span>
                                        <span class="customer_shipping_adresss2">${
                                            order[0].shipping_customer_address_2
                                        }</span>
                                        <span class="customer_shipping_country">${
                                            order[0].shipping_customer_city +
                                            " " +
                                            order[0].shipping_customer_postcode
                                        }</span>
                                    </div>
                                </div>
                            </div>`
            ...
            if (!transfers) {
                $(".total_order_details").append(
                    ...
                    <div class="d-flex button_order_action">
                        ...
                        <button id="validWrapper" transfers="` +
                        transfers +
                        `" from_dolibarr="` +
                        from_dolibarr +
                        `" type="button" onclick="validWrapOrder(true)" class="btn btn-primary d-flex mx-auto"> Valider avec étiquette</button>
                        </div>
                        <div class="to_hide action_button d-flex w-100 justify-content-center flex-wrap">
                            <button id="validWrapper" transfers="` +
                        transfers +
                        `" from_dolibarr="` +
                        from_dolibarr +
                        `" type="button"  onclick="$('.modal_no_label').modal('show')" class="btn btn-primary d-flex mx-auto"> Valider </button>
                        </div>
                    </div>`
                );
            } else {
                ...
                <div class="d-flex button_order_action">
                    <div class="to_hide action_button d-flex w-100 justify-content-center flex-wrap">
                        <button style="max-width:300px" id="validWrapper" transfers="` +
                        transfers +
                        `" from_dolibarr="` +
                        from_dolibarr +
                        `" type="button"  onclick="$('.modal_no_label').modal('show')" class="btn btn-primary d-flex mx-auto"> Valider </button>
            ...
            Object.entries(order).forEach(([key, value]) => {
                var gift = parseFloat(value.cost) == 0.0 ? true : false;
                total_product_order = total_product_order + value.quantity;
                listProduct += `
                    <div class="${
                        value.quantity == 0 ? "no_product" : ""
                    } row row-main to_hide">
                        <div class="col-2"> 
                            ${
                                value.image
                                    ? '<img loading="lazy" class="img-fluid" src="' +
                                      value.image +
                                      '">'
                                    : '<img loading="lazy" class="img-fluid" src="assets/images/icons/default_image.png">'
                            }
                            </div>
                            <div class="col-8">
                                <div class="row d-flex">
                                    <p><b>${
                                        gift
                                            ? '<span class="text-success">(Cadeau)</span>'
                                            : ""
                                    } ${value.name} (x${value.quantity})</b></p>
                                    ${
                                        value.quantity == 0
                                            ? "<p class='out_of_stock'>Pas en stock</p>"
                                            : ""
                                    }
                                </div>
                                <div class="row d-flex">
                                    <p class="text-muted">${
                                        gift
                                            ? '<span class="text-success">' +
                                              parseFloat(value.cost).toFixed(
                                                  2
                                              ) +
                                              "€"
                                            : parseFloat(value.cost).toFixed(2)
                                    }</p>
                                </div>
                            </div>
            ...
            if (is_distributor) {
                ...
                Object.entries(order).forEach(([key, value]) => {
                    innerHtml += `<div class="barcode_${value.barcode ?? 0} ${
                        value.pick_control == value.quantity ? "pick" : ""
                    } product_order p-2 d-flex w-100 align-items-center justify-content-between detail_product_order_line">
                        <div class="column11 d-flex align-items-center detail_product_name_order">
                            <span>${
                                value.cost == 0
                                    ? `<span class="text-danger">(Cadeau) </span>`
                                    : ``
                            }${value.name}</span>
                        </div>
                        <span class="column22">${parseFloat(value.cost).toFixed(
                            2
                        )}</span>
                        <span class="quantity column33"><span class="quantity_pick_in">${
                            value.pick_control
                        }</span> / <span class="quantity_to_pick_in">${
                        value.quantity
                    }</span> </span>
                    </div>`;
                });
                ...
                if (localStorage.getItem("barcode_verif_wrapper")) {
                    var list_barcode = localStorage.getItem(
                        "barcode_verif_wrapper"
                    );
                    if (list_barcode) {
                        Object.keys(JSON.parse(list_barcode)).forEach(function (
                            k,
                            v
                        ) {
                            if (JSON.parse(list_barcode)[k]) {
                                var order_id =
                                    JSON.parse(list_barcode)[k].order_id;
                                JSON.parse(list_barcode)[k].products.forEach(
                                    function (item, key) {
                                        $(
                                            "#order_" +
                                                order_id +
                                            ...
                                            .find(".quantity_pick_in")
                                            .text(
                                                JSON.parse(list_barcode)[k]
                                                    .quantity[key]
                                            );
                                        if (
                                            parseInt(
                                ...
                                if (
                                    $("#order_" + order_id + " .pick").length ==
                                    $("#order_" + order_id + " .product_order")
                                        .length
                                ) {
                                    $(
                                        "#order_" +
                    ...
                    $(
                        ".barcode_" +
                            localStorage.getItem(
                                "product_quantity_verif_wrapper"
                            )
                    ).removeClass("pick");
                }
                /* ----------------------------------------------------------------------------- */
...
$(".validate_pick_in").on("click", function () {
    ...
    if (
        $("#order_" + order_id + " .pick").length ==
            $("#order_" + order_id + " .product_order").length &&
        localStorage.getItem("barcode_verif_wrapper") &&
...
$("body").on("click", ".check_all", function () {
    if ($(this).prop("checked")) {
        $("#order_" + $(this).attr("data-id") + " .checkbox_label").each(
            function (index) {
        ...
        $("#order_" + $(this).attr("data-id") + " .checkbox_label").prop(
            "checked",
            false
        );
    }
    ...
    $(".line_items_label").each(function (index) {
        ...
        if ($(this).find(".checkbox_label").prop("checked")) {
            total_weight =
                ...
                parseFloat($(this).find(".weight").text()) *
                    $(this).find(".quantity_product_label").val();
        }
    });
    ...
    if (label) {
        $.ajax({
            ...
            data: {
                ...
                order_id: order_id,
                from_validWraper: true,
                from_dolibarr: from_dolibarr,
                transfers: transfers,
            },
        }).done(function (data) {
            if (JSON.parse(data).success) {
                ...
                Object.entries(product_order).forEach(([key, value]) => {
                    product =
                        value.quantity - value.total_quantity == 0
                            ? product + 0
                            : product + 1;
                    ...
                    if (value.quantity - value.total_quantity == 0) {
                        ...
                        total_weight =
                            parseFloat(total_weight) +
                            parseFloat(weight_product) * value.quantity;
                    }

                    innerHtml += `<div class="line_${
                        value.product_woocommerce_id
                    } ${
                        value.quantity - value.total_quantity == 0
                            ? "disabled_text"
                            : ""
                    } line_items_label d-flex w-100 align-items-center justify-content-between">
                            <span style="width: 50px">
                                <input name="label_product[]" ${
                                    value.quantity - value.total_quantity == 0
                                        ? "disabled"
                                        : "checked"
                                } class="checkbox_label form-check-input" type="checkbox" value="${
                        value.product_woocommerce_id
                    }" aria-label="Checkbox for product order">	
                            </span>
                            <span class="w-50">${value.name}</span>
                            <span class="w-25">${value.cost}</span>
                            <span class="w-25" ><input class="quantity_product_label" ${
                                value.quantity - value.total_quantity == 0
                                    ? "disabled"
                                    : ""
                            } min="1" max="${
                        ...
                        value.product_woocommerce_id
                            ...
                            <input class="base_total_quantity" type="hidden" value="${
                                value.quantity
                            }">
                            
                            </span>
                            <span class="weight w-25">${
                                value.weight ? value.weight : 0
                            }</span>
                        </div>`;
                });
                ...
                innerHtml +=
                    `<div class="total_weight mt-3 w-100 d-flex justify-content-end">Poids : ` +
        ...
        $.ajax({
            ...
            data: {
                ...
                pick_items_quantity: pick_items_quantity,
                transfers: transfers,
                from_dolibarr: from_dolibarr,
            },
            dataType: "html",
                ...
                if (JSON.parse(data).success) {
                        ...
                        $(".wrapper").append(
                            ...
                            <div class="success_message alert alert-warning border-0 bg-warning alert-dismissible fade show">
                                <div class="text-center text-white">
                                    <span class="response_detail_type">Facturation </span>: ` +
                                JSON.parse(data).message +
                                `
                                    ${
                                        error
                                            ? '<br><span class="response_detail_type">Étiquette </span>: ' +
                                              error +
                                              ""
                                            : ""
                                    }
                    ...
                    if (redirection && !error) {
                        document.location.href =
                            "https://preparation.elyamaje.com/labels?status=&created_at=&order_woocommerce_id=" +
                            order_id;
                    }
                } else {
...
$(".valid_generate_label").on("click", function () {
    ...
    $(".line_items_label").each(function () {
        if (
            !$(this).find(".checkbox_label").prop("disabled") &&
            $(this).find(".checkbox_label").prop("checked")
        ) {
        ...
        if (
            $(this).find(".quantity_product_label").val() !=
            parseInt($(this).find(".total_quantity").text())
        ) {
            products_left = true;
        }
    });
    ...
    if (element_is_checked) {
        if (!localStorage.getItem("labels")) {
            const data = [
                {
                    order_id: order_id,
                    data: [$(".labelProductsInfo").serialize()],
                    data_array: [$(".labelProductsInfo").serializeArray()],
                    num: 1,
                },
            ];
    ...
    if (
        number_element == number_element_checked &&
            ...
            Object.keys(labels_products).forEach(function (k, v) {
                if (order_id == labels_products[k].order_id) {
                    $.ajax({
                        ...
                        method: "POST",
                        data:
                            labels_products[k].data[0] +
                            "&_token=" +
                            $("input[name=_token]").val() +
                            "&from_js=true&from_dolibarr=" +
                            from_dolibarr +
                            "&transfers=" +
                            transfers,
                        async: false,
                        ...
                        if (JSON.parse(data).success) {
                            ...
                            if (JSON.parse(data).file) {
                                ...
                                $.ajax({
                                    ...
                                    error: function (xhr) {
                                        $.ajax({
                                            url:
                                                "http://localhost:8000/imprimerEtiquetteThermique?port=USB&protocole=ZEBRA&adresseIp=&etiquette=" +
                                                label,
                                            metho: "GET",
                                            async: false,
                                            success: function (data) {},
                            ...
                            if (
                                parseInt(k) + parseInt(1) ==
                                parseInt(labels_products.length)
                            ) {
                                // Facture la commande
                                setTimeout(function () {
    ...
    if (data) {
        ...
        Object.keys(data).forEach(function (k, v) {
            if (data[k].name.includes("label_product")) {
                ...
                data[k].name.includes("quantity") &&
                data[k].name.includes(product_id)
            ) {
                var base_quantity = parseInt(
                    $(".line_" + product_id + " .total_quantity").text()
                );
                if (base_quantity > 0) {
                    $(".line_" + product_id + " .quantity_product_label").val(
                        base_quantity - data[k].value
                    );
                    $(".line_" + product_id + " .total_quantity").text(
                        base_quantity - data[k].value
                    );
                    $(".line_" + product_id + " .quantity_product_label").attr(
                        "max",
                        base_quantity - data[k].value
                    );
                }
                if (base_quantity - data[k].value == 0 && data[k].value != 0) {
                    ...
                    $(".line_" + product_id + " .checkbox_label ").attr(
                        "checked",
                        false
                    );
                    $(".line_" + product_id + " .checkbox_label ").attr(
        ...
        $(".line_items_label").each(function () {
            ...
            $(this)
                .find(".quantity_product_label")
                .val(parseInt($(this).find(".total_quantity").text()));
            $(this)
                .find(".total_quantity")
                .text($(this).find(".base_total_quantity").val());
            $(this)
                .find(".quantity_product_label")
                .attr("max", $(this).find(".base_total_quantity").val());
            $(this)
                .find(".quantity_product_label")
                .val($(this).find(".base_total_quantity").val());
        });
    }
...
document.addEventListener("keydown", function (e) {
    if (
        ...
        $(".modal_order").hasClass("show") &&
        !$(".modal_verif_order").hasClass("show")
    ) {
        var order_id = $("#order_id").val();
        if (!isNaN(parseInt(e.key))) {
            ...
            if ($("#barcode").val().length == 13) {
                if (
                    $("#order_" + order_id + " .barcode_" + $("#barcode").val())
                        .length > 0
                ) {
                    if (
                        $(
                        ...
                        if (
                            ...
                            $(".name_quantity_product").text(
                                $(
                                    ...
                                    .children(".detail_product_name_order")
                                    .children("span")
                                    .text()
                            );
                            $("#product_to_verif").val($("#barcode").val());
                            $("#quantity_product_to_verif").text(
                                parseInt(
                                    $(
                                        "#order_" +
                                            order_id +
                        ...
                        if (
                            ...
                            $("#order_" + order_id + " .validate_pick_in").css(
                                "background-color",
                                "#16e15e"
                            );
                            $("#order_" + order_id + " validate_pick_in").css(
        ...
        if (!isNaN(parseInt(e.key))) {
            ...
            if ($("#barcode_verif").val().length == 13) {
                if (
                    ...
                    $("#quantity_product_to_verif").text(
                        parseInt($("#quantity_product_to_verif").text()) - 1
                    );
...
function saveItem(order_id, mutiple_quantity) {
    if (mutiple_quantity) {
        var quantity_pick_in = parseInt(
            $("#order_" + order_id + " .barcode_" + $("#barcode_verif").val())
                .find(".quantity_pick_in")
                .text()
        );
    } else {
    ...
    if (localStorage.getItem("barcode_verif_wrapper")) {
        ...
        if (order_object) {
            if (mutiple_quantity) {
                var index = order_object.products.indexOf(
                    $("#barcode_verif").val()
                );
                if (index != -1) {
