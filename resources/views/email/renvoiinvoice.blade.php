            ...
            <table style="max-width:600px;border-style:solid; border-width:1px; border-color:#c9c9c9;" width="100%" border="0" cellspacing="0" cellpadding="25">
                <tr>
                    <td class="header" style="text-align:center;">
                        ...
                        <p style="text-align:center; line-height: 17px;">En raison du volume élevé de commandes, nous avons rencontré une erreur technique indépendante de notre volonté lors de la génération de votre facture initiale.</p>
                        <p style="text-align:center; line-height: 17px;">Vous trouverez, ci-joint, votre facture N° {{ $ref_order }}</p>
                        <p style="text-align:center; line-height: 17px;">Nous nous excusons pour tout inconvénient que cela aurait pu causer et nous vous remercions pour votre compréhension.</p>
